...
public interface SpawnerStat<T> {
    ...
    default Identifier getId() {
        return Objects.requireNonNull(SpawnerStats.REGISTRY.getKey(this), this + " is not registered");
    }
    ...
    static Component createTooltip(SpawnerStat<?> stat, MutableComponent value) {
        return AntipothicSpawners.lang("misc", "value_concat", stat.name(), value.withStyle(ChatFormatting.GRAY)).withStyle(ChatFormatting.GREEN);
    }
